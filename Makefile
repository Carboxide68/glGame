...
additionalFiles = common/common.cpp camera/camera.cpp glObjects/vao.cpp glObjects/vbo.cpp glObjects/ibo.cpp imgui2/imgui.cpp 
additionalFiles += imgui2/imgui_draw.cpp imgui2/imgui_demo.cpp imgui2/imgui_widgets.cpp imgui2/imgui_impl_opengl3.cpp 
additionalFiles += imgui2/imgui_impl_glfw.cpp misc/skybox.cpp mesh/mesh.cpp mesh/polygon.cpp
